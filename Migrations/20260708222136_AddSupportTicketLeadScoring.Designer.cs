...
namespace V3RII.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260708222136_AddSupportTicketLeadScoring")]
    partial class AddSupportTicketLeadScoring
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("V3RII.Domain.Entities.KnowledgeArticleChunk", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("KnowledgeArticleId", "ChunkIndex")
                        .IsUnique();

                    b.HasIndex("Product", "IsPublished");

                    b.ToTable("KnowledgeArticleChunks");
                });
            ...
            modelBuilder.Entity("V3RII.Domain.Entities.KnowledgeArticleChunk", b =>
                {
                    b.HasOne("V3RII.Domain.Entities.KnowledgeArticle", "KnowledgeArticle")
                        .WithMany()
